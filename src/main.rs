...
async fn mantenimiento() -> impl Responder {
    HttpResponse::Ok().content_type("text/html").body(include_str!("templates/mantenimiento.html"))
}
...
async fn pagina_404() -> impl Responder {
    HttpResponse::NotFound().content_type("text/html").body(include_str!("templates/404.html"))
}
...
async fn carrusel_view(pool: web::Data<PgPool>) -> impl Responder {
    ...
    HttpResponse::Ok().content_type("text/html").body(html_final)
}
